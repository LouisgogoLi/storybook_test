<template>
  <div class="courses">
    <a class="card" v-for="item in oCourses.data" :key="item.id">
...
export default {
  setup() {
    const oCourses = reactive({
      data: [
        {
          id: 286,
          name: "2021 Vue3 專業職人 | 入門篇 (預購中)",
          photo:
